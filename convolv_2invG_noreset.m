...
% STUB CODE STUB CODE
% this is abolutely wrong, just here for testing.
% what we really want to do is calculate both the twostage adaptive AND a
% onestage with parameters coming from m2 s2 and then combine them before
% calculating the log likelihood.
% with a probability of r, force the first function to a dirac delta. this
% implements the concept of "no reset"
if rand < r
    m1 = 0;
    s1 = 0;
end
