function [pd_max, pd_maxflag, lcross, lcrossflag] = twostage_optimize_plot(datatrain, datacross, TolFun, TolX)
...
%set max iter to 1
    fminsearch_options = optimset('TolFun',TolFun, 'TolX', TolX,'MaxIter', 1);
