...
function [P,h,flag,E]=convolv_2invG_adapt_nov_meanstddev(t,m1,s1,m2,s2,h)

[m1, s1, m2, s2] = meanstddev_to_ms(m1,s1,m2,s2);
...
[m1, s1, m2, s2] = ms_to_meanstddev(m1,s1,m2,s2);
