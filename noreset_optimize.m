function [pd_max_noreset, pd_maxflag_noreset, lcross_noreset, lcrossflag_noreset] = noreset_optimize(datatrain, datacross, TolFun, TolX)
...
for i=1:(length(id)*length(r))
    ...
    %recalculate the likelihhod of the parameters
